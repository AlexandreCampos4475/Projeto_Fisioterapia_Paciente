...
const pedidosIcon = require('./img/pedidos.png');
const uploadIcon = require('./img/upload.png');
const enviarIcon = require('./img/enviar.png');
const setaIcon = require('./img/seta.png');
